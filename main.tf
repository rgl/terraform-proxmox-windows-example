...
# see https://registry.terraform.io/providers/bpg/proxmox/0.61.1/docs/data-sources/virtual_environment_vms
data "proxmox_virtual_environment_vms" "windows_templates" {
  tags = ["windows-2022-uefi", "template"]
}

# see https://registry.terraform.io/providers/bpg/proxmox/0.61.1/docs/data-sources/virtual_environment_vm
...
resource "proxmox_virtual_environment_vm" "example" {
  ...
  # see https://registry.terraform.io/providers/bpg/proxmox/0.61.1/docs/resources/virtual_environment_vm#initialization
  initialization {
