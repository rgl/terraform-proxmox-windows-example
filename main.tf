...
# see https://registry.terraform.io/providers/bpg/proxmox/0.95.0/docs/data-sources/virtual_environment_vms
data "proxmox_virtual_environment_vms" "windows_templates" {
  tags = [var.windows_template, "template"]
}

# see https://registry.terraform.io/providers/bpg/proxmox/0.95.0/docs/data-sources/virtual_environment_vm
...
resource "proxmox_virtual_environment_vm" "example" {
  ...
  # see https://registry.terraform.io/providers/bpg/proxmox/0.95.0/docs/resources/virtual_environment_vm#initialization
  initialization {
